...
Route::group(['prefix'=>'admin','middleware' => ['auth']], function(){
    ...
    Route::get('videos','PostController@indexAdmin');
    Route::post('videos/{id}','PostController@update')->where('id', '[0-9]+');
    Route::post('videos/languages','PostController@addLanguage');
    Route::post('videos/languages/edit','PostController@updateLanguage');
});
